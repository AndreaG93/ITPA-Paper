...
\begin{itemize}
\justifying
\item IoT devices rely on cloud back-end services for \textbf{data storage}, \textbf{backup}, \textbf{firmware updates}, \textbf{media streaming} \cite{mazhar2020characterizing} ... and \textbf{remote access and integration using RESTful Web API} (exploiting the so-called \textit{cloud-based connectivity pattern}).
\end{itemize}
\end{description}
\end{itemize}
